describe "Laboratory Test", ->
  describe "Performed", ->
    ...
    it "should show just a single Component", ->
      ...
      expect(JSON.stringify(laboratoryTestPerformed.components())).toEqual '[{"result":1,"code":{"code":"0270346","system":"ICD-10-PCS"}}]'
    ...
    it "should show two Components", ->
      ...
      expect(JSON.stringify(laboratoryTestPerformed.components())).toEqual '[{"result":1,"code":{"code":"0270346","system":"ICD-10-PCS"}},{"result":1,"code":{"code":"1","system":"Source of Payment Typology"}}]'
    ...
    it "should show Component with referenceRange low and high without units", ->
      ...
      expect(JSON.stringify(laboratoryTestPerformed.components())).toEqual '[{"result":2,"code":{"code":"0270346","system":"ICD-10-PCS"},"range":{"low":"1","high":"3","lowClosed":true,"highClosed":true}}]'
    ...
    it "should show Component with referenceRange low only", ->
      ...
      expect(JSON.stringify(laboratoryTestPerformed.components())).toEqual '[{"result":2,"code":{"code":"0270346","system":"ICD-10-PCS"},"range":{"low":"1","lowClosed":true,"highClosed":true}}]'
    ...
    it "should show Component with referenceRange high only", ->
      ...
      expect(JSON.stringify(laboratoryTestPerformed.components())).toEqual '[{"result":2,"code":{"code":"0270346","system":"ICD-10-PCS"},"range":{"high":"3","lowClosed":true,"highClosed":true}}]'
