describe "Encounter", ->
  describe "Performed", ->
    ...
    it "should show just the single facilityLocation", ->
      ...
      expect(JSON.stringify(encounterPerformed.facilityLocations())).toEqual '[{"_code":{"code":"G0438","system":"HCPCS","display":"Annual Wellness Visit"},"_locationPeriod":{"low":"2017-08-30T01:00:00.00+0000","high":"2017-08-31T01:00:00.00+0000","lowClosed":true,"highClosed":true}}]'
    ...
    it "should show two Facilities", ->
      ...
      expect(JSON.stringify(encounterPerformed.facilityLocations())).toEqual '[{"_code":{"code":"G0438","system":"HCPCS","display":"Annual Wellness Visit"},"_locationPeriod":{"low":"2017-08-30T01:00:00.00+0000","high":"2017-08-31T01:00:00.00+0000","lowClosed":true,"highClosed":true}},{"_code":{"code":"105401000119101","system":"SNOMED-CT","display":"Diabetes"},"_locationPeriod":{"low":"2017-08-30T01:00:00.00+0000","high":"2017-08-31T01:00:00.00+0000","lowClosed":true,"highClosed":true}}]'
    ...
    it "should show locationPeriod with undefined end date", ->
      ...
      expect(JSON.stringify(encounterPerformed.facilityLocations())).toEqual '[{"_code":{"code":"G0438","system":"HCPCS","display":"Annual Wellness Visit"},"_locationPeriod":{"low":"1970-01-01T00:00:08.00+0000","lowClosed":true,"highClosed":true}}]'
    ...
    it "should show locationPeriod with undefined start date", ->
      ...
      expect(JSON.stringify(encounterPerformed.facilityLocations())).toEqual '[{"_code":{"code":"G0438","system":"HCPCS","display":"Annual Wellness Visit"},"_locationPeriod":{"high":"2017-08-31T08:00:00.00+0000","lowClosed":true,"highClosed":true}}]'
