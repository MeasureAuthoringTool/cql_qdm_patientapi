describe "Symptom", ->
  describe "Prevalence", ->
    ...
    it "should use infinite date for abatement", ->
      ...
      expect(JSON.stringify(symptom.prevalencePeriod())).toEqual '{"low":"2017-08-31T01:00:00.000+00:00","high":"9999-12-31T23:59:59.999+00:00","lowClosed":true,"highClosed":true}'
