describe "Intervention", ->
  describe "Performed", ->
    ...
    it "should show valid relevantPeriod", ->
      ...
      expect(JSON.stringify(interventionPerformed.relevantPeriod())).toEqual '{"low":"2017-08-31T01:00:00.000+00:00","high":"2017-08-31T02:00:00.000+00:00","lowClosed":true,"highClosed":true}'
    ...
    it "should return a result", ->
      ...
      expect(JSON.stringify(interventionPerformed.result())).toEqual('{"code":"164059009","system":"SNOMED-CT","version":null,"display":"Pass Or Refer"}')
